...
## Environments
- Preview: https://main--aem-boilerplate-ue-4--mayankjindalmj.hlx.page/
- Live: https://main--aem-boilerplate-ue-4--mayankjindalmj.hlx.live/
...
1. Open the `aem-boilerplate-ue-4` directory in your favorite IDE and start coding :)
